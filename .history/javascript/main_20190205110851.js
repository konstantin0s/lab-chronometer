...
var start =  btnLeft.innerHTML

var intervalRef = null;

 btnLeft.addEventListener("click", function(event) {
  if (intervalId == 0) { //start if pause
    // intervalId = 1; //keep track of state
      ...
      if (seconds === 60) {
         seconds = 0;
           minutes++;
      console.log("This is: " + intervalId);
    
        secDec.innerText = seconds;
        btnLeft.innerHTML = "PAUSE";

         minDec.innerText = minutes;
         if (start.innerHTML == "PAUSE") {
          clearInterval(intervalRef);  //change from pause to start.
          btnLeft.innerHTML = "START";
         }
